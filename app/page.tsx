  ...
  const features = [
    {
      ...
      description: "Track your ride in real-time with live location updates"
    },
    {
      icon: <Clock className="w-8 h-8 text-[var(--color-accent)]" />,
      title: "Quick Booking",
      description: "Book a ride in under 30 seconds with our easy interface"
    },
    {
      icon: <Shield className="w-8 h-8 text-[var(--color-accent)]" />,
      title: "Safe & Secure",
      description: "All riders are verified and trips are insured for your safety"
    },
    {
      icon: <Star className="w-8 h-8 text-[var(--color-accent)]" />,
      title: "Top Rated",
      description: "Highly rated drivers ensuring quality service every time"
    }
  ];
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="text-center p-6 hover:shadow-lg transition-shadow bg-[var(--color-muted)]/10 border-[var(--color-border)]">
              <CardHeader>
